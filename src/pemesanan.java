...
public class pemesanan extends javax.swing.JFrame {
    ...
    protected void txt() {
        ...
        tb_kembali.setText(output);
        tb_kembali.setEnabled(false);
        tb_pinjam.setText(ft.format(date));
        tb_pinjam.setEnabled(false);
    ...
    private void initComponents() {
        ...
        cb_gedung = new javax.swing.JComboBox<String>();
